...
SECRET_KEY = "django-insecure-608rabf&$vyt5_38-tq+va!s-@uaqbctyh=o6@%t11+4idp-0-"
...
if DATABASE_URL:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": BASE_DIR / "db_product_service.sqlite3",
        }
    }
...
os.environ.setdefault('OTEL_RESOURCE_ATTRIBUTES', 
    ...
    'db.connection_string=sqlite:///db_product_service.sqlite3,'
    'peer.service=product_service_db'
)
