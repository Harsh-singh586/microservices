...
SECRET_KEY = "django-insecure--eejid0y6(@@44xhgirif=c#er6jr#*35qnl7+4_y82)bz5izn"
...
# Use DATABASE_URL environment variable if available (Docker), otherwise SQLite
...
if DATABASE_URL:
    ...
    DATABASES = {
        "default": {
            ...
            "NAME": BASE_DIR / "db_order_service.sqlite3",
        }
    }
...
os.environ.setdefault('OTEL_RESOURCE_ATTRIBUTES', 
    ...
    'db.system=sqlite,'
    'db.name=order_service_db,'
    'db.connection_string=sqlite:///db_order_service.sqlite3,'
    'peer.service=order_service_db'
)
